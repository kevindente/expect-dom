...
describe('to.handle', function() {
  ...
  it('should throw exception when assert handle on pure DOM', function() {
    $('#clickme').bind("click", $.noop);

    expect(function () {
      expect(document.getElementById('clickme')).to.handle("click");
    }).to.throwException(function (e) {
      expect(e).to.contain('not support');
    });
  });
...
describe('to.handleWith', function() {
  ...
  it('should throw exception when assert handleWith on pure DOM', function() {
    $('#clickme').bind("click", $.noop);

    expect(function () {
      expect(document.getElementById('clickme')).to.handleWith("click", $.noop);
    }).to.throwException(function (e) {
      expect(e).to.contain('not support');
    });
  });
